...
void kan_fixed_length_bitset_set (struct kan_fixed_length_bitset_t *bitset, kan_instance_size_t index, bool value)
{
...
bool kan_fixed_length_bitset_get (const struct kan_fixed_length_bitset_t *bitset, kan_instance_size_t index)
{
    const kan_instance_size_t item_index = index / KAN_BITSET_ITEM_BITS;
    KAN_ASSERT (item_index < bitset->items)
    const kan_instance_size_t bit_index = index % KAN_BITSET_ITEM_BITS;
...
bool kan_fixed_length_bitset_check_intersection (const struct kan_fixed_length_bitset_t *bitset,
