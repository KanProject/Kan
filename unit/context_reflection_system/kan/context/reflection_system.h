...
///   kan_memory_size_t bootstrap_iteration_index): This function is always called after reflection generator
...
///   kan_memory_size_t iteration_index): Called during generation iteration. Follows the same rules as for generation
