...
LOG_API void kan_log_callback_add (kan_log_callback_t callback, kan_memory_size_t user_data);

/// \brief Removes callback with given user data from callback sequence.
LOG_API void kan_log_callback_remove (kan_log_callback_t callback, kan_memory_size_t user_data);
