...
enum kan_platform_modifier_mask_t
{
    ...
    KAN_PLATFORM_MODIFIER_MASK_ANY_SHIFT =
        KAN_PLATFORM_MODIFIER_MASK_LEFT_SHIFT | KAN_PLATFORM_MODIFIER_MASK_RIGHT_SHIFT,

    KAN_PLATFORM_MODIFIER_MASK_ANY_CONTROL =
        KAN_PLATFORM_MODIFIER_MASK_LEFT_CONTROL | KAN_PLATFORM_MODIFIER_MASK_RIGHT_CONTROL,

    KAN_PLATFORM_MODIFIER_MASK_ANY_ALT = KAN_PLATFORM_MODIFIER_MASK_LEFT_ALT | KAN_PLATFORM_MODIFIER_MASK_RIGHT_ALT,
    KAN_PLATFORM_MODIFIER_MASK_ANY_GUI = KAN_PLATFORM_MODIFIER_MASK_LEFT_GUI | KAN_PLATFORM_MODIFIER_MASK_RIGHT_GUI,
};
